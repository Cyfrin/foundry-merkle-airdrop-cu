...
sign :; 
	cast wallet sign --private-key ${DEFAULT_ANVIL_KEY} --no-hash ${shell cast call ${AIRDROP_ADDRESS} "getMessageHash(address,uint256)" ${DEFAULT_ANVIL_ADDRESS} ${AIRDROP_AMOUNT} --rpc-url http://localhost:8545}
